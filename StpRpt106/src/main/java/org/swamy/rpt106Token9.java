...
/**
 *  Simple program to parse Report 106.
 *    For all record type #1,
 *    replace ninth element - eexpected value two character string
 *      with a three character string built of the two characters in original string
 *      and a third character of x20 ==> ' '
 *
 **/

// Preprocessor - tranvese a folder and pick all files with file name pattern of Rpt 106
//
...
public class rpt106Token9 {
    ...
    private  void readFile() {
        try {
            File helloWorldFile = new File(fileName);
